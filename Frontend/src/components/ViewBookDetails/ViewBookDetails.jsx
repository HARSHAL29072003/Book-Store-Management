      ...
      {Data && (
        <div className=" px-4 md:px-12 py-8 bg-zinc-900 flex flex-col lg:flex-row gap-8 itms-start">
            ...
            <div className="flex flex-col lg:flex-row justify-around bg-zinc-800  p-12 rounded ">
              ...
              {isLoggedIn === true && role === "admin" && (
                <div className="flex flex-col md:flex-row lg:flex-col items-center justify-between lg:justify-start mt-4 lg:mt-0">
                  ...
                  <button
                    className="text-red rounded lg:rounded-full text-3xl p-3 mt-8 md:mt-0 lg:mt-8 bg-white flex items-center justify-center"
                    onClick={deleteBook}
                  >
                    <MdDelete />{" "}
          ...
          <div className="p-4 w-full lg:w-3/6">
            ...
            <p className="flex mt-4 items-center jusyify-start text-zinc-400">
